...
@@application/shared_components/logic/application_items/ai_contry_area.sql
@@application/shared_components/logic/application_computations/ai_contry_area.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/from_to_yes_no.sql
@@application/shared_components/user_interface/lovs/list_blood_type.sql
@@application/shared_components/user_interface/lovs/list_gender.sql
@@application/shared_components/user_interface/lovs/list_type_phone.sql
@@application/shared_components/user_interface/lovs/patient_first_name_ptt.sql
